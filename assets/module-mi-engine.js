...
(function () {
  ...
  async function submitData(isTest) {
    ...
    var message = isTest ? "MI Test Submission" : "MI Official Submission";
    ...
    var payload = {
      metadata: {
        ...
        module: "mi",
        module_name: "Market Intelligence Deep Dive",
        questions_count: window.QUESTIONS.length,
        source: "MI Engine v" + CONFIG.schemaVersion,
        is_test: !!isTest
      },
      message: message,
    ...
    try {
      ...
      if (isTest) {
        ...
        window.location.href = "module-mi-thank-you.html";
      }
    } catch (e) {

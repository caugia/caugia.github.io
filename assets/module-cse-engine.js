/* ===========================================================
   CAUGIA CSE MODULE ENGINE v1.3 (FULL)
...
(function () {
  ...
  const ENGINE_NAMES = {
    ...
    2: "Customer Health & Risk Management",
    3: "Adoption & Engagement",
    4: "Renewal & Retention",
    5: "Expansion & Upsell",
    6: "CS Operations & Infrastructure"
  };
  ...
  async function submitData(isTest) {
    ...
    var payload = {
      ...
      message: isTest ? "CSE Test Submission" : "CSE Official Submission",
